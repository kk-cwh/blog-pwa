    ...
    leave-active-class="animated slideOutLeft">
      <div class="app-slider" v-if="show">
        ...
        <div class="list-menu">
          ...
          <div class="list-li" @click="routerTo('blogAbout')">
